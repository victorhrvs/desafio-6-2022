      ...
      <div className="main">
        ...
        <div className="card">
          <div className="tab">
            ...
            <button id='btn1' className={isActiveBnt1 ? 'active': null} onClick={handleClick1}>
              Colaboradores
            </button>
            <button id='btn2' className={isActiveBnt2 ? 'active': null} onClick={handleClick2}>Cargos</button>
            <div className="line" />
          </div>
          <div id="tab-1">
            <Agents />
